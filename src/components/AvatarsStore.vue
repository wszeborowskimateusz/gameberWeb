                    ...
                    <div class="col-12 store__item"
                        ...
                        <figure class="mx-auto item__figure">
                            ...
                            <img v-if="currentItemsCategory === 1"
                                ...
                                width="500" height="300" :src="item.img">
...
export default {
  ...
  methods: {
    ...
    fetchAvatars() {
      avatarsStoreService.getAvatarsSupply(this.$store.state.users.user)
        .then(((avatars) => { this.avatars = avatars; }));
    },
    fetchBackgroundImages() {
      avatarsStoreService.getBackgroundImagesSupply(this.$store.state.users.user)
        .then(((images) => { this.backgroundImages = images; }))
