<template>
    <div class="card text-center">
        <div class="card-header">
          ...
          Witaj podróżniku!
          <img height="50" class="m-3" :src="imagesGetter.getImgUrl('game_map/suitcase.png')" />
        </div>
        <div class="card-body">
          <img class="card-img-top img-fluid"
          :src="imagesGetter.getImgUrl('game_map/crossroad.jpg')" alt="crossroad image">
          ...
          <a :href="testPath" class="btn btn-primary m-2">
            ...
            <img height="50" :src="imagesGetter.getImgUrl('game_map/mountain.png')" />
          </a>
          <a href="" class="btn btn-primary m-2">
            Wybieram drogę przez dolinę
            <img height="50" :src="imagesGetter.getImgUrl('game_map/meadow.png')" />
          </a>
        </div>
        <div class="card-footer text-muted">
          ...
          <img height="30" :src="imagesGetter.getImgUrl('game_map/help.png')" />
        </div>
      </div>
</template>
<style scoped>
