...
!(function (e, t) {
  ...
  const J = new Y(); const K = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/;
  const Z = /[A-Z]/g; function ee(e, t, n) { let r; let i; if (void 0 === n && e.nodeType === 1) if (r = `data-${t.replace(Z, '-$&').toLowerCase()}`, typeof (n = e.getAttribute(r)) === 'string') { try { n = (i = n) === 'true' || i !== 'false' && (i === 'null' ? null : i === `${+i}` ? +i : K.test(i) ? JSON.parse(i) : i); } catch (e) {}J.set(e, t, n); } else n = void 0; return n; }k.extend({
